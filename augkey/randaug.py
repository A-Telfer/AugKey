...
class RandAugment:
    ...
    def plan_augment(self):
        ...
        Returns:
            magnitude : int
            augmentation : list of Operation
    ...
    def apply_image(self, image, magnitude, augment_operations, directions):
        ...
        image : PIL.Image
        """
        for direction, operation in zip(directions, augment_operations):
            image = operation.transform_image(image, magnitude, direction)
        return image

    def apply_keypoints(self, keypoints, magnitude, augment_operations,
                        directions):
    ...
    def apply_inv_keypoints(self, keypoints, magnitude, augment_operations,
                            directions):
